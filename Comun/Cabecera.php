                ...
                <div class="navbar-collapse collapse ">
					...
					<?php 
						foreach ($MenuPrincipal as $k => $v)
						{
							if ($PagID == $v)
							{
								$IndexIdiomaPageName = "PagName".$k;
								echo '<li class="active"><a href="ControladorWEB.php?PagMenu='.$v.'">'.$idioma['PagName'.$k].'</a></li>';
							}
							else
							{
								echo '<li><a href="ControladorWEB.php?PagMenu='.$v.'">'.$idioma['PagName'.$k].'</a></li>';
							}
						}
					?>
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
						  ...
						  <li><a href="#"><?php echo $idioma['Login'] ?></a></li>
