...
try
	{
		...
		{
			case "ED":
			$consulta = $_TABLATABLONEDITORIAL->AlmacenarBD(array_slice($_POST, 1) );
			break;
			case "RE":
			$consulta = $_TABLAREVISTAS->AlmacenarBD(array_slice($_POST, 1) );
			break;
			case "CON":
			$consulta = $_TABLACONFERENCIASORG->AlmacenarBD(array_slice($_POST, 1) );
			break;
		}
