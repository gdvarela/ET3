...
('Nombre 1', 'C1',"1992-1-19", "1992-1-20","Empre1");
INSERT INTO `S_CONTRATO` (`Nombre_Contrato`, `IDContrato`, `FechaIni_Contrato`, `FechaFin_Contrato`, `IDEmpresa`) VALUES
('Nombre 2', 'C2',"1992-1-20", "1992-1-21","Empre3");
...
('Empre1', 'http://www.marca.com/',"INSA S. L.", "imagen2.jpg","Empre1");
INSERT INTO `S_EMPRESAS` (`IDEmpresa`, `Web_Empresa`, `Nombre_Empresa`, `IDImagen_Empresa`, `IDParticipante`) VALUES
('Empre2', 'http://www.marca.com/',"INSA S. L. 2", "imagen2.jpg","Empre2");
INSERT INTO `S_EMPRESAS` (`IDEmpresa`, `Web_Empresa`, `Nombre_Empresa`, `IDImagen_Empresa`, `IDParticipante`) VALUES
('Empre3', 'http://www.marca.com/',"INSA S. L. 3", "imagen2.jpg","Empre3");
-- --------------------------------------------------------
...
('Grupo1', 'http://sing.ei.uvigo.es', "imagen3.jpg","SING","Grupo1");
INSERT INTO `S_GRUPOS` (`IDGrupo`, `Web_Grupo`, `IDImagen_Grupo`, `Nombre_Grupo`, `IDParticipante`) VALUES
('Grupo2', 'http://sing.ei.uvigo.es', "imagen3.jpg","SING2","Grupo2");
INSERT INTO `S_GRUPOS` (`IDGrupo`, `Web_Grupo`, `IDImagen_Grupo`, `Nombre_Grupo`, `IDParticipante`) VALUES
('Grupo3', 'http://sing.ei.uvigo.es', "imagen3.jpg","SING3","Grupo3");
-- --------------------------------------------------------
...
('Institu1', 'http://www.marca.com/', "imagen.jpg","CNI","Institu1");
INSERT INTO `S_INSTITUCIONES` (`IDInstitucion`, `Web_Institucion`, `IDImagen_Institucion`, `Nombre_Institucion`, `IDParticipante`) VALUES
('Institu2', 'http://www.marca.com/', "imagen.jpg","CNI2","Institu2");
INSERT INTO `S_INSTITUCIONES` (`IDInstitucion`, `Web_Institucion`, `IDImagen_Institucion`, `Nombre_Institucion`, `IDParticipante`) VALUES
('Institu3', 'http://www.marca.com/', "imagen.jpg","CNI3","Institu3");
...
('Grupo2', 'Grupo'),
('Grupo3', 'Grupo'),
('Institu1', 'Institucion'),
('Institu2', 'Institucion'),
('Institu3', 'Institucion');
