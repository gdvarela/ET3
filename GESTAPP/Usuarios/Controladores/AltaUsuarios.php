...
include '../Vistas/V_AltaUsuarios.php';
...
//--------------------- RECUPERACION DATOS PREVIOS
	...
	$datosPrevios = new Usuario();
	if (isset($_SESSION['recargaAU']))
	{
		//Si esta set la variable recarga significa que hubo un error -> recarga de datos
		$datosPrevios->CargarDatosSesion($_SESSION['recargaUsuarioAlta']);
...
//se instancia la clase Alta Usuario
$princ_view = new AltaUsuario();

//se invoca el metodo Display de Alta Usuario
// con los datos previos introducidos por el usuario (si hay)
