...
function DisplayContent($idioma,$miembros,$puestos)
{
						...
						<div class="row">
							...
							<?php 
								...
								foreach($puestos as $puesto => $num)
								{
									...
									{
										if ($miembro->puesto == $puesto)
										{
											$miembros2[] = $miembro;
										}
									}
									
									$this->mostrarMiembro($miembros2);
				...
				echo '
						<div class="col-md-'.$espacioMiembro.'">
							...
							<div class="team-member">
								<!-- Image -->
								<img class="img-responsive center-block" src="'.$RutaRelativaControlador.$miembros[$i - $Comienzo]->img.'" alt="">
								<!-- Name -->
								<h4>'.$miembros[$i - $Comienzo]->nombre.'</h4>
