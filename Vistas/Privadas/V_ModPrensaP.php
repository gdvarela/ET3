...
?>
	...
	<div class="container">
		<form id="borrarActual" action="<?php echo $procesadores[$identificadoresPrivados["DPrensa"]]?>" method="POST">
						<input type="hidden" name="BORRAR" value="<?php echo $noticia["Titulo_Noticia"]?>"/>
			</form>
			<div class="row">
				<div class="col-md-12">
					<form role="form" action="<?php echo $procesadores[$identificadoresPrivados["MPrensa"]]?>">
					<input type="hidden" name="ClaveAnt" value="<?php echo $noticia["Titulo_Noticia"]?>" />
					<?php
